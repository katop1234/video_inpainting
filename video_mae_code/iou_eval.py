...
def generate_segmentations(model, store_path, prompt_csv, davis_prompt_path, davis_2x2_prompt_path, davis_image_prompt_path):
...
def run_evaluation_method(store_path):
    ...
    davis_path_2x2 = '/shared/dannyt123/Datasets/DAVIS_video_2x2'
    davis_path_image = '/shared/dannyt123/Datasets/DAVIS_image'
