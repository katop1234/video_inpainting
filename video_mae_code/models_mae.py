...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(
        ...
        cls_embed=True,
        pred_t_dim=16,
        st_adapter_encoder=False, #False for regular training, True for training only st_adapters in encoder
        st_adapter_decoder=False, #False for regular training, True for training only st_adapters in decoder
        **kwargs,
    ):
        ...
        self.blocks = nn.ModuleList(
            [
                video_vit.Block(
                    ...
                    adapter_pre_attn=st_adapter_encoder,
                    adapter_pre_mlp=st_adapter_encoder,
                )
        ...
        self.decoder_blocks = nn.ModuleList(
            [
                video_vit.Block(
                    ...
                    qk_scale=None,
                    norm_layer=norm_layer,
                    adapter_pre_attn=st_adapter_decoder,
                    adapter_pre_mlp=st_adapter_decoder,
                )
